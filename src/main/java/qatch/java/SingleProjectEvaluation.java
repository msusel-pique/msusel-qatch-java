...
public class SingleProjectEvaluation {
    ...
    public static void main(String[] args) {
        ...
        QualityModelLoader qmImporter = new QualityModelLoader(new File("src/main/resources/models/qualityModel_java.xml").getPath());
        ...
        IAnalyzer metricsAnalyzer = new CKJMAnalyzer();
        IAnalyzer findingsAnalyzer = new PMDAnalyzer();
